...
class DRQN(nn.Module):
    ...
    def __init__(self, num_inputs, num_outputs, sequence_length, use_deeper_net):
    ...
    @classmethod
    def train_model(cls, online_net, target_net, optimizer, batch, batch_size, sequence_length, gamma, use_deeper_net):
